...
const TopHeader = () => {
    return (
        <div className='w-full h-11 bg-slate-900'>
            <div className=' mx-auto px-24 flex justify-between'>
                ...
                <div className=' text-white flex items-center'>
                    ...
                    <div className=' w-60 h-11 bg-slate-700 text-2xl flex items-center justify-center '>

                        <div>
                            <FontAwesomeIcon className='mr-5 hover:text-orange-600' icon={faFacebook} />
                            ...
                            <FontAwesomeIcon className=' hover:text-orange-600' icon={faLinkedin} />
                        </div>
                    </div>
