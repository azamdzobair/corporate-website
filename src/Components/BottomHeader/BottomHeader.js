        ...
        <nav className='bg-blue-500   relative h-14 z-10 '>
            <div className=' container mx-auto px-6  flex items-center justify-between '>
                ...
                <div>
                    ...
                    <ul className={`absolute bg-blue-700 w-full  top-10 right-0 p-4 text-center duration-500 ease-in list-none  ${open ? 'top-14' : 'hidden'} sm:h-14  sm:relative sm:top-0 sm:flex sm:items-center `}>
                        {
