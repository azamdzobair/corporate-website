...
const About = () => {
    return (
        <div className='my-20'>
            <div>
                <h1 className=' text-4xl text-center font-bold mb-5'>Introduction About Our Business Firm </h1>
            ...
            <div className='mt-16 flex items-center justify-center'>
                <img src={img02} />
                <div className='bg-green-500 w-1/2 p-10'>
            ...
            <div className='flex'>
                ...
                <div className='w-1/2 relative '>
                    ...
                    <div className=' bg-gray-900 bg-opacity-50 w-full h-[450px] top-0 left-0 absolute p-12'>
                        ...
                        <div className='flex'>
                            <div className='w-1/2 mb-4'>
                                <h1 className='text-1g text-white font-bold mr-6 '>Monday - Friday 9:00 AM - 6:00 pm Sunday & Public Holidays (Closed)
                                </h1>
                            </div>
